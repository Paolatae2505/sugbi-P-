...
return [(function (){var pred__61285 = cljs.core.instance_QMARK_;
var expr__61286 = reactive_val;
if(cljs.core.truth_((pred__61285.cljs$core$IFn$_invoke$arity$2 ? pred__61285.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__61286) : pred__61285.call(null,reagent.ratom.RAtom,expr__61286)))){
return "ra";
} else {
if(cljs.core.truth_((pred__61285.cljs$core$IFn$_invoke$arity$2 ? pred__61285.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__61286) : pred__61285.call(null,reagent.ratom.RCursor,expr__61286)))){
return "rc";
} else {
if(cljs.core.truth_((pred__61285.cljs$core$IFn$_invoke$arity$2 ? pred__61285.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__61286) : pred__61285.call(null,reagent.ratom.Reaction,expr__61286)))){
return "rx";
} else {
if(cljs.core.truth_((pred__61285.cljs$core$IFn$_invoke$arity$2 ? pred__61285.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__61286) : pred__61285.call(null,reagent.ratom.Track,expr__61286)))){
return "tr";
} else {
return "other";
}
