...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_62394 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_62394(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_62395 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_62395(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62399 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62399(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62400 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62400(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62401 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62401(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62402 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62402(reader);
}
});
...
var G__62412 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__62413 = s.append(c);
c = G__62412;
s = G__62413;
continue;
}
