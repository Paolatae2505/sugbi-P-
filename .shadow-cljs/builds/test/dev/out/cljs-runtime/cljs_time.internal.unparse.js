...
var periods__$1 = cljs.core.vec((function (){var G__63533 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63532_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__63532_SHARP_,(0),(3));
}),G__63533);
} else {
return G__63533;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__63545){
var vec__63546 = p__63545;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63546,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63546,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__63549 = pattern;
switch (G__63549) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63549)].join('')));
...
return p1__63550_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__63551_SHARP_){
return p1__63551_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__63552_SHARP_){
return p1__63552_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__63553_SHARP_){
return p1__63553_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__63554_SHARP_){
return p1__63554_SHARP_.getHours();
});

break;
case "day":
return (function (p1__63555_SHARP_){
return p1__63555_SHARP_.getDate();
});

break;
case "month":
return (function (p1__63556_SHARP_){
return p1__63556_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__63557_SHARP_){
return p1__63557_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63558__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__63559){
var vec__63560 = p__63559;
var seq__63561 = cljs.core.seq(vec__63560);
var first__63562 = cljs.core.first(seq__63561);
var seq__63561__$1 = cljs.core.next(seq__63561);
var key = first__63562;
var args = seq__63561__$1;
var G__63563 = key;
...
break;
case "ordinal-suffix":
var vec__63564 = (function (){var G__63567 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__63567) : syntax_list.call(null,G__63567));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63563__$1)].join('')));
...
var d = value;
var G__63571 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__63572 = G__63571;
var seq__63573 = cljs.core.seq(vec__63572);
var first__63574 = cljs.core.first(seq__63573);
var seq__63573__$1 = cljs.core.next(seq__63573);
var unparser = first__63574;
var more = seq__63573__$1;
var s = "";
var d__$1 = d;
var G__63571__$1 = G__63571;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__63581 = G__63571__$1;
...
var unparser__$1 = first__63583;
var more__$1 = seq__63582__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__63584 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63584,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63584,(1),null);
var G__63603 = d__$3;
var G__63604 = more__$1;
var G__63605 = s__$3;
d__$1 = G__63603;
G__63571__$1 = G__63604;
s__$1 = G__63605;
continue;
}
break;
