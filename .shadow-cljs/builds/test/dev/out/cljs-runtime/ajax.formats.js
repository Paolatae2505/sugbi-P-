...
var G__62061 = request;
var G__62062 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__62061,G__62062) : ajax.formats.get_format.call(null,G__62061,G__62062));
} else {
...
return cljs.core.some((function (p1__62066_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__62066_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__62068){
var map__62069 = p__62068;
var map__62069__$1 = cljs.core.__destructure_map(map__62069);
var request = map__62069__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62069__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__62071 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__62071.cljs$core$IFn$_invoke$arity$1 ? fexpr__62071.cljs$core$IFn$_invoke$arity$1(response) : fexpr__62071.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__62074){
var map__62075 = p__62074;
var map__62075__$1 = cljs.core.__destructure_map(map__62075);
var request = map__62075__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62075__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__62072_SHARP_){
return ajax.formats.get_accept_entries(request,p1__62072_SHARP_);
