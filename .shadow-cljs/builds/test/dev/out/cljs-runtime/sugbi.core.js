...
var with_let64721 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let64721","with-let64721",746653489));
var temp__5808__auto___64724 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___64724 == null)){
} else {
var c__54293__auto___64725 = temp__5808__auto___64724;
if((with_let64721.generation === c__54293__auto___64725.ratomGeneration)){
...
(with_let64721.generation = c__54293__auto___64725.ratomGeneration);
}

var init64722 = (with_let64721.length === (0));
var expanded_QMARK_ = ((((init64722) || (cljs.core.not(with_let64721.hasOwnProperty((0))))))?(with_let64721[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let64721[(0)]));
