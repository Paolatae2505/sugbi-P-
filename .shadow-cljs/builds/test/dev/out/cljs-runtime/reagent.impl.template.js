...
var G__61175 = o;
reagent.impl.template.goog$module$goog$object.set(G__61175,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__61195__i < G__61195__a.length) {G__61195__a[G__61195__i] = arguments[G__61195__i + 0]; ++G__61195__i;}
  args = new cljs.core.IndexedSeq(G__61195__a,0,null);
} 
...
var G__61176 = o;
reagent.impl.template.goog$module$goog$object.set(G__61176,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__61198__i < G__61198__a.length) {G__61198__a[G__61198__i] = arguments[G__61198__i + 0]; ++G__61198__i;}
  args = new cljs.core.IndexedSeq(G__61198__a,0,null);
} 
...
var G__61177 = props;
var G__61177__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61177,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__61177);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61177__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__61178 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61178,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__61178;
}
})(),id_class);
...
var G__61179 = (cljs.core.count(argv) - first_child);
switch (G__61179) {
case (0):
...
var vec__61180 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61180,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61180,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61180,(2),null);
...
var temp__5808__auto___61206 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___61206 == null)){
} else {
var key_61207 = temp__5808__auto___61206;
(jsprops.key = key_61207);
}
...
var temp__5808__auto___61208 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___61208 == null)){
} else {
var key_61209 = temp__5808__auto___61208;
(jsprops.key = key_61209);
}
...
var temp__5808__auto___61210 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___61210 == null)){
} else {
var key_61211 = temp__5808__auto___61210;
(jsprops.key = key_61211);
}
...
var temp__5808__auto___61212 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___61212 == null)){
} else {
var key_61213 = temp__5808__auto___61212;
(jsprops.key = key_61213);
}
...
var temp__5808__auto___61214 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___61214 == null)){
} else {
var key_61215 = temp__5808__auto___61214;
(jsprops.key = key_61215);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61183_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__61183_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__61184 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61184,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61184,(1),null);
...
break;
default:
var G__61217 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__61218 = compiler;
v = G__61217;
compiler = G__61218;
continue;
...
var G__61188 = tag;
var G__61188__$1 = (((G__61188 instanceof cljs.core.Keyword))?G__61188.fqn:null);
switch (G__61188__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template61190 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template61190 = (function (opts,id,fn_to_element,parse_fn,meta61191){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template61190.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61192,meta61191__$1){
var self__ = this;
var _61192__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template61190(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta61191__$1));
}));

(reagent.impl.template.t_reagent$impl$template61190.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61192){
var self__ = this;
var _61192__$1 = this;
return self__.meta61191;
}));

(reagent.impl.template.t_reagent$impl$template61190.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template61190.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template61190.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template61190.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template61190.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template61190.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta61191","meta61191",-978745443,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template61190.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template61190.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template61190");

(reagent.impl.template.t_reagent$impl$template61190.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template61190");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template61190.
 */
reagent.impl.template.__GT_t_reagent$impl$template61190 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template61190(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta61191){
return (new reagent.impl.template.t_reagent$impl$template61190(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta61191));
});

}

return (new reagent.impl.template.t_reagent$impl$template61190(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
