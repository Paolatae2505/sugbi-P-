...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__62082){
var map__62083 = p__62082;
var map__62083__$1 = cljs.core.__destructure_map(map__62083);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62083__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__62086_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__5045__auto__ = p1__62086_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__62087){
var map__62088 = p__62087;
var map__62088__$1 = cljs.core.__destructure_map(map__62088);
var request = map__62088__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62088__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
