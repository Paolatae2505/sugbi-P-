...
var trimmed = (function (){var G__62807 = text;
if((G__62807 == null)){
return null;
} else {
return clojure.string.trim(G__62807);
}
})();
...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__62808){
var map__62809 = p__62808;
var map__62809__$1 = cljs.core.__destructure_map(map__62809);
var state = map__62809__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62809__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62809__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__62884 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__62885 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__62884;
remaining = G__62885;
continue;
} else {
var G__62889 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__62890 = cljs.core.rest(remaining);
buf = G__62889;
remaining = G__62890;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__62810){
var map__62811 = p__62810;
var map__62811__$1 = cljs.core.__destructure_map(map__62811);
var state = map__62811__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62811__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62811__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62811__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62811__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62811__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__62812){
var map__62813 = p__62812;
var map__62813__$1 = cljs.core.__destructure_map(map__62813);
var state = map__62813__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62813__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62813__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__62815){
var map__62816 = p__62815;
var map__62816__$1 = cljs.core.__destructure_map(map__62816);
var state = map__62816__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62816__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62816__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__62814_SHARP_){
var vec__62821 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__62814_SHARP_,(1),(cljs.core.count(p1__62814_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62821,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62821,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62825)].join('');
} else {
return G__62825;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__62824_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__62824_SHARP_,(1),(cljs.core.count(p1__62824_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__62826){
var map__62827 = p__62826;
var map__62827__$1 = cljs.core.__destructure_map(map__62827);
var state = map__62827__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62827__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__62828){
var map__62829 = p__62828;
var map__62829__$1 = cljs.core.__destructure_map(map__62829);
var state = map__62829__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62829__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__62830){
var map__62831 = p__62830;
var map__62831__$1 = cljs.core.__destructure_map(map__62831);
var state = map__62831__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62831__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62831__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__5043__auto__ = paragraph;
if(cljs.core.truth_(and__5043__auto__)){
var G__62834 = next_line;
var G__62834__$1 = (((G__62834 == null))?null:clojure.string.trim(G__62834));
if((G__62834__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__62834__$1,"```");
}
} else {
return and__5043__auto__;
}
...
markdown.transformers.code = (function markdown$transformers$code(text,p__62835){
var map__62836 = p__62835;
var map__62836__$1 = cljs.core.__destructure_map(map__62836);
var state = map__62836__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62836__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var indent_code_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62836__$1,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62836__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62836__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62836__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62836__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62836__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
...
if(cljs.core.truth_(code)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [[markdown.common.escape_code(clojure.string.replace_first(text,/    /,"\n")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__62837 = state;
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62837,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__62837;
}
})()], null);
...
if((num_spaces >= (4))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["<pre><code>",markdown.common.escape_code(clojure.string.replace_first(text,/    /,"")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__62838 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"code","code",1586293142),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"indented-code","indented-code",-904930175),true], 0));
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62838,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__62838;
}
})()], null);
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__62839){
var map__62840 = p__62839;
var map__62840__$1 = cljs.core.__destructure_map(map__62840);
var state = map__62840__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62840__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62840__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62840__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62840__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62840__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = (function (){var G__62841 = next_line;
var G__62841__$1 = (((G__62841 == null))?null:clojure.string.trim(G__62841));
if((G__62841__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__62841__$1,"```");
}
})();
...
var vec__62842 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62842,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62842,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__62849){
var map__62850 = p__62849;
var map__62850__$1 = cljs.core.__destructure_map(map__62850);
var state = map__62850__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62850__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62850__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62850__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__5045__auto__ = code;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__62851){
var map__62852 = p__62851;
var map__62852__$1 = cljs.core.__destructure_map(map__62852);
var state = map__62852__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62852__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62852__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62852__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62852__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__62857_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__62858){
var vec__62859 = p__62858;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62859,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62859,(1),null);
...
var vec__62862 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62862,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62862,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62862,(2),null);
var vec__62865 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62865,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62865,(1),null);
...
var vec__62875 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62875,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62875,(1),null);
...
var G__62958 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__62959 = cljs.core.rest(remain);
var G__62960 = key;
acc = G__62958;
remain = G__62959;
prev_key = G__62960;
