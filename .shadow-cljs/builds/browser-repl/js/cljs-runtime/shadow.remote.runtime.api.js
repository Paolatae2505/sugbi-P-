...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_64917 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_64917(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_64918 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_64918(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_64919 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_64919(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_64920 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_64920(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_64923 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_64923(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_64924 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_64924(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__64911,callback){
var map__64912 = p__64911;
var map__64912__$1 = cljs.core.__destructure_map(map__64912);
var input = map__64912__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64912__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64912__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
