...
var i_62250 = (0);
while(true){
if((i_62250 < arr.length)){
(arr[i_62250] = null);

var G__62251 = (i_62250 + (1));
i_62250 = G__62251;
continue;
} else {
}
...
var i_62258 = (self__.level + (1));
while(true){
if((i_62258 <= (new_level + (1)))){
(update[i_62258] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_62263 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_62263[i]));
} else {
x__$2.forward.push((((i < links_62263.length))?(links_62263[i]):null));
}

if((i < links_62263.length)){
(links_62263[i] = x__$2);
} else {
links_62263.push(x__$2);
}
...
var i_62266 = (0);
while(true){
if((i_62266 <= self__.level)){
var links_62267 = (update[i_62266]).forward;
if((x__$1 === (((i_62266 < links_62267.length))?(links_62267[i_62266]):null))){
(links_62267[i_62266] = (x__$1.forward[i_62266]));

var G__62268 = (i_62266 + (1));
i_62266 = G__62268;
continue;
} else {
var G__62269 = (i_62266 + (1));
i_62266 = G__62269;
continue;
}
} else {
...
var G__62271 = nx;
var G__62272 = (level__$1 - (1));
x = G__62271;
level__$1 = G__62272;
continue;
} else {
var G__62273 = x;
var G__62274 = (level__$1 - (1));
x = G__62273;
level__$1 = G__62274;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__62284 = nx;
var G__62285 = (level__$1 - (1));
x = G__62284;
level__$1 = G__62285;
continue;
} else {
var G__62286 = x;
var G__62287 = (level__$1 - (1));
x = G__62286;
level__$1 = G__62287;
continue;
}
