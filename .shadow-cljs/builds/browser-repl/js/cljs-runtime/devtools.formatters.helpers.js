...
var G__61041 = devtools.prefs.pref(v);
v = G__61041;
continue;
} else {
return v;
...
}catch (e60959){var _e__54070__auto__ = e60959;
return false;
}})();
...
}catch (e60969){var _e__54070__auto__ = e60969;
return false;
}})();
...
}catch (e60972){var _e__54070__auto__ = e60972;
return false;
}}
}
});
...
var vec__60982 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60982,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60982,(1),null);
...
return cljs.core.some((function (p1__61020_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__61020_SHARP_);
}),template);
});
