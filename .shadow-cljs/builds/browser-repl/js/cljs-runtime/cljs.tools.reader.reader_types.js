...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_61750 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_61750(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_61751 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_61751(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_61752 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_61752(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_61753 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_61753(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_61757 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_61757(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_61758 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_61758(reader);
}
});
...
var G__61766 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__61767 = s.append(c);
c = G__61766;
s = G__61767;
continue;
}
