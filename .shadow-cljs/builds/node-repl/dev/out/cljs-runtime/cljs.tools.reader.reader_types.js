...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_58089 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_58089(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_58090 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_58090(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_58094 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_58094(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_58096 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_58096(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_58097 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_58097(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_58099 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_58099(reader);
}
});
...
var G__58139 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__58140 = s.append(c);
c = G__58139;
s = G__58140;
continue;
}
