...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_67900 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_67900(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_67901 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_67901(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_67903 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_67903(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_67904 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_67904(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_67905 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_67905(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_67906 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_67906(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_67907 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_67907(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_67909 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_67909(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_67910 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_67910(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_67912 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_67912(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k67803,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__67813 = k67803;
var G__67813__$1 = (((G__67813 instanceof cljs.core.Keyword))?G__67813.fqn:null);
switch (G__67813__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k67803,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__67814){
var vec__67815 = p__67814;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67815,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67815,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__67802){
var self__ = this;
var G__67802__$1 = this;
return (new cljs.core.RecordIter((0),G__67802__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this67804,other67805){
var self__ = this;
var this67804__$1 = this;
return (((!((other67805 == null)))) && ((((this67804__$1.constructor === other67805.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67804__$1.status,other67805.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67804__$1.body,other67805.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67804__$1.status_text,other67805.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67804__$1.headers,other67805.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67804__$1.was_aborted,other67805.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67804__$1.__extmap,other67805.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k67803){
var self__ = this;
var this__5350__auto____$1 = this;
var G__67862 = k67803;
var G__67862__$1 = (((G__67862 instanceof cljs.core.Keyword))?G__67862.fqn:null);
switch (G__67862__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k67803);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__67802){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__67864 = cljs.core.keyword_identical_QMARK_;
var expr__67865 = k__5352__auto__;
if(cljs.core.truth_((pred__67864.cljs$core$IFn$_invoke$arity$2 ? pred__67864.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__67865) : pred__67864.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__67865)))){
return (new ajax.protocols.Response(G__67802,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67864.cljs$core$IFn$_invoke$arity$2 ? pred__67864.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__67865) : pred__67864.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__67865)))){
return (new ajax.protocols.Response(self__.status,G__67802,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67864.cljs$core$IFn$_invoke$arity$2 ? pred__67864.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__67865) : pred__67864.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__67865)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__67802,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67864.cljs$core$IFn$_invoke$arity$2 ? pred__67864.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__67865) : pred__67864.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__67865)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__67802,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67864.cljs$core$IFn$_invoke$arity$2 ? pred__67864.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__67865) : pred__67864.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__67865)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__67802,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__67802),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__67802){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__67802,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__67806){
var extmap__5385__auto__ = (function (){var G__67891 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__67806,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__67806)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__67891);
} else {
return G__67891;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__67806),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__67806),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__67806),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__67806),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__67806),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
