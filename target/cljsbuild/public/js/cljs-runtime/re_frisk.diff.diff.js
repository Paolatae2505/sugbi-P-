...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__64384_SHARP_,p2__64383_SHARP_){
if((p2__64383_SHARP_ == null)){
return null;
} else {
return p1__64384_SHARP_;
}
}),coll);
}
});
re_frisk.diff.diff.diff_coll = (function re_frisk$diff$diff$diff_coll(a,b){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function re_frisk$diff$diff$diff_coll_$_iter__64389(s__64390){
...
var c__5521__auto__ = cljs.core.chunk_first(s__64390__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__64392 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__64391 = (0);
while(true){
if((i__64391 < size__5522__auto__)){
var key = cljs.core._nth(c__5521__auto__,i__64391);
cljs.core.chunk_append(b__64392,(function (){var val_a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(a,key);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__64392),re_frisk$diff$diff$diff_coll_$_iter__64389(cljs.core.chunk_rest(s__64390__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__64392),null);
}
} else {
var key = cljs.core.first(s__64390__$2);
...
})(),re_frisk$diff$diff$diff_coll_$_iter__64389(cljs.core.rest(s__64390__$2)));
}
} else {
return null;
}
