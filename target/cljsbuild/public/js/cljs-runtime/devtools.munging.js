...
var o55364 = temp__5802__auto__;
var temp__5802__auto____$1 = (o55364["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o55365 = temp__5802__auto____$1;
return (o55365["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__52794__auto__ = f;
return (o__52794__auto__["toString"]).call(o__52794__auto__);
} else {
return "";
}
}catch (e55366){var _ = e55366;
return "";
}});
...
try{var o__52794__auto___55762 = t;
(o__52794__auto___55762["cljs$lang$ctorPrWriter"]).call(o__52794__auto___55762,t,writer);
}catch (e55391){var __55763 = e55391;
}
...
var char_code = (function (){var o__52794__auto__ = (new String(char$));
return (o__52794__auto__["charCodeAt"]).call(o__52794__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__52794__auto__ = String;
return (o__52794__auto__["fromCharCode"]).call(o__52794__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__55434 = num_code;
switch (G__55434) {
case (1):
return (185);
...
var o__52794__auto__ = String;
return (o__52794__auto__["fromCharCode"]).call(o__52794__auto__,superscript_code);
});
/**
...
}catch (e55456){var _e__52814__auto__ = e55456;
return false;
}})())){
...
var vec__55457 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55457,(0),null);
...
var len__5769__auto___55769 = arguments.length;
var i__5770__auto___55770 = (0);
while(true){
if((i__5770__auto___55770 < len__5769__auto___55769)){
args__5775__auto__.push((arguments[i__5770__auto___55770]));

var G__55771 = (i__5770__auto___55770 + (1));
i__5770__auto___55770 = G__55771;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__55475){
var vec__55476 = p__55475;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55476,(0),null);
...
var G__55772 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__55773 = cljs.core.butlast(remaining_tokens);
name_tokens = G__55772;
remaining_tokens = G__55773;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq55473){
var G__55474 = cljs.core.first(seq55473);
var seq55473__$1 = cljs.core.next(seq55473);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55474,seq55473__$1);
}));
...
var vec__55483 = cljs.core.split_with((function (p1__55480_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__55480_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55483,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55483,(1),null);
...
var vec__55497 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55497,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55497,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__55775 = cljs.core.rest(remaining_tokens);
var G__55776 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__55775;
name_tokens = G__55776;
continue;
} else {
...
var vec__55502 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55502,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55502,(1),null);
var vec__55505 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55505,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55505,(1),null);
var vec__55508 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55508,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55508,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55508,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55508,(3),null);
...
var vec__55513 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55513,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55513,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55513,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55513,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55513,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55513,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__55516 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55516,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55516,(1),null);
var vec__55519 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55519,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55519,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__55523 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__55523) : devtools.munging.parse_fn_info_deep.call(null,G__55523));
})()));
}
} else {
return fn_info;
...
var G__55783 = (arity + (1));
var G__55784 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__55526){
var vec__55527 = p__55526;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55527,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55527,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55549_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__55549_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55550_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__55550_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__55575){
var vec__55576 = p__55575;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55576,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq55564){
var G__55565 = cljs.core.first(seq55564);
var seq55564__$1 = cljs.core.next(seq55564);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55565,seq55564__$1);
}));
...
var G__55583 = arg;
var G__55583__$1 = (((G__55583 instanceof cljs.core.Keyword))?G__55583.fqn:null);
switch (G__55583__$1) {
...
var map__55643 = options;
var map__55643__$1 = cljs.core.__destructure_map(map__55643);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55643__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55643__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55643__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55643__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__55656 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(5),null);
...
var o__52794__auto__ = f;
return (o__52794__auto__["getBasis"]).call(o__52794__auto__);
});
/**
...
}catch (e55685){var _e__52814__auto__ = e55685;
...
var G__55791 = (obj[cljs.core.first(path)]);
var G__55792 = cljs.core.rest(path);
obj = G__55791;
path = G__55792;
continue;
} else {
...
var _STAR_ = (function (accum,p__55733){
var vec__55734 = p__55733;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55734,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55734,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__55751){
var vec__55752 = p__55751;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55752,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55752,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55752,(2),null);
...
var post_process = (function (p__55756){
var vec__55757 = p__55756;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55757,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55757,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55755_SHARP_){
return (obj[cljs.core.first(p1__55755_SHARP_)]);
}),sorted_matches);
