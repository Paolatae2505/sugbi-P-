...
var G__68418 = request;
var G__68419 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__68418,G__68419) : ajax.formats.get_format.call(null,G__68418,G__68419));
} else {
...
return cljs.core.some((function (p1__68495_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__68495_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__68533){
var map__68534 = p__68533;
var map__68534__$1 = cljs.core.__destructure_map(map__68534);
var request = map__68534__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68534__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__68536 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__68536.cljs$core$IFn$_invoke$arity$1 ? fexpr__68536.cljs$core$IFn$_invoke$arity$1(response) : fexpr__68536.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__68538){
var map__68539 = p__68538;
var map__68539__$1 = cljs.core.__destructure_map(map__68539);
var request = map__68539__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68539__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__68537_SHARP_){
return ajax.formats.get_accept_entries(request,p1__68537_SHARP_);
