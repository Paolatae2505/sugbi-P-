...
return [(function (){var pred__56801 = cljs.core.instance_QMARK_;
var expr__56802 = reactive_val;
if(cljs.core.truth_((pred__56801.cljs$core$IFn$_invoke$arity$2 ? pred__56801.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__56802) : pred__56801.call(null,reagent.ratom.RAtom,expr__56802)))){
return "ra";
} else {
if(cljs.core.truth_((pred__56801.cljs$core$IFn$_invoke$arity$2 ? pred__56801.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__56802) : pred__56801.call(null,reagent.ratom.RCursor,expr__56802)))){
return "rc";
} else {
if(cljs.core.truth_((pred__56801.cljs$core$IFn$_invoke$arity$2 ? pred__56801.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__56802) : pred__56801.call(null,reagent.ratom.Reaction,expr__56802)))){
return "rx";
} else {
if(cljs.core.truth_((pred__56801.cljs$core$IFn$_invoke$arity$2 ? pred__56801.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__56802) : pred__56801.call(null,reagent.ratom.Track,expr__56802)))){
return "tr";
} else {
return "other";
}
