...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__56535 = c;
var G__56535__$1 = (((G__56535 == null))?null:G__56535.prototype);
if((G__56535__$1 == null)){
return null;
} else {
return G__56535__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__56538 = c;
var G__56538__$1 = (((G__56538 == null))?null:G__56538.prototype);
if((G__56538__$1 == null)){
return null;
} else {
return G__56538__$1.render;
}
})() == null)))));
});
...
var c = this;
var G__56590_56643 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__56590_56643 == null)){
} else {
reagent.ratom.dispose_BANG_(G__56590_56643);
}
...
var renders_56644 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_56645 = cljs.core.first(cljs.core.vals(renders_56644));
...
if((cljs.core.count(renders_56644) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_56644))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_56645)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_56645], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__56625 = o;
reagent.impl.component.goog$module$goog$object.set(G__56625,cljs.core.name(k),v);
...
return (function() { 
var G__56647__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__56648__i < G__56648__a.length) {G__56648__a[G__56648__i] = arguments[G__56648__i + 0]; ++G__56648__i;}
  args = new cljs.core.IndexedSeq(G__56648__a,0,null);
} 
return G__56647__delegate.call(this,args);};
G__56647.cljs$lang$maxFixedArity = 0;
G__56647.cljs$lang$applyTo = (function (arglist__56649){
var args = cljs.core.seq(arglist__56649);
return G__56647__delegate(args);
});
