...
var G__69052 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__69053 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__69052;
remaining = G__69053;
continue;
} else {
var G__69055 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__69056 = cljs.core.rest(remaining);
buf = G__69055;
remaining = G__69056;
continue;
...
markdown.transformers.br = (function markdown$transformers$br(text,p__68970){
var map__68971 = p__68970;
var map__68971__$1 = cljs.core.__destructure_map(map__68971);
var state = map__68971__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68971__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68971__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__68973){
var map__68974 = p__68973;
var map__68974__$1 = cljs.core.__destructure_map(map__68974);
var state = map__68974__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68974__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68974__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__68972_SHARP_){
var vec__68975 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__68972_SHARP_,(1),(cljs.core.count(p1__68972_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68975,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68975,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68979)].join('');
} else {
return G__68979;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__68978_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__68978_SHARP_,(1),(cljs.core.count(p1__68978_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__68980){
var map__68981 = p__68980;
var map__68981__$1 = cljs.core.__destructure_map(map__68981);
var state = map__68981__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68981__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__68982){
var map__68983 = p__68982;
var map__68983__$1 = cljs.core.__destructure_map(map__68983);
var state = map__68983__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__68984){
var map__68985 = p__68984;
var map__68985__$1 = cljs.core.__destructure_map(map__68985);
var state = map__68985__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68985__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68985__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__5043__auto__ = paragraph;
if(cljs.core.truth_(and__5043__auto__)){
var G__68986 = next_line;
var G__68986__$1 = (((G__68986 == null))?null:clojure.string.trim(G__68986));
if((G__68986__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__68986__$1,"```");
}
} else {
return and__5043__auto__;
}
...
markdown.transformers.code = (function markdown$transformers$code(text,p__68988){
var map__68990 = p__68988;
var map__68990__$1 = cljs.core.__destructure_map(map__68990);
var state = map__68990__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68990__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var indent_code_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68990__$1,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68990__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68990__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68990__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68990__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68990__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
...
if(cljs.core.truth_(code)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [[markdown.common.escape_code(clojure.string.replace_first(text,/    /,"\n")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__68991 = state;
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68991,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__68991;
}
})()], null);
...
if((num_spaces >= (4))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["<pre><code>",markdown.common.escape_code(clojure.string.replace_first(text,/    /,"")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__68994 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"code","code",1586293142),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"indented-code","indented-code",-904930175),true], 0));
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68994,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__68994;
}
})()], null);
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__69000){
...
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
...
var next_line_closes_QMARK_ = (function (){var G__69002 = next_line;
var G__69002__$1 = (((G__69002 == null))?null:clojure.string.trim(G__69002));
if((G__69002__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__69002__$1,"```");
}
})();
...
var vec__69005 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69005,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69005,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__69010){
var map__69011 = p__69010;
var map__69011__$1 = cljs.core.__destructure_map(map__69011);
var state = map__69011__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69011__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69011__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69011__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__5045__auto__ = code;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__69012){
var map__69013 = p__69012;
var map__69013__$1 = cljs.core.__destructure_map(map__69013);
var state = map__69013__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69013__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69013__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69013__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69013__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return (function (p1__69014_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__69014_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__69015){
var vec__69016 = p__69015;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69016,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69016,(1),null);
...
var vec__69019 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69019,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69019,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69019,(2),null);
var vec__69022 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69022,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69022,(1),null);
...
var vec__69028 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69028,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69028,(1),null);
...
var G__69132 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__69133 = cljs.core.rest(remain);
var G__69134 = key;
acc = G__69132;
remain = G__69133;
prev_key = G__69134;
