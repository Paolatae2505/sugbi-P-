...
var i_61389 = (0);
while(true){
if((i_61389 < arr.length)){
(arr[i_61389] = null);

var G__61390 = (i_61389 + (1));
i_61389 = G__61390;
continue;
} else {
}
...
var i_61399 = (self__.level + (1));
while(true){
if((i_61399 <= (new_level + (1)))){
(update[i_61399] = self__.header);

var G__61400 = (i_61399 + (1));
i_61399 = G__61400;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_61401 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_61401[i]));
} else {
x__$2.forward.push((((i < links_61401.length))?(links_61401[i]):null));
}

if((i < links_61401.length)){
(links_61401[i] = x__$2);
} else {
links_61401.push(x__$2);
}
...
var i_61404 = (0);
while(true){
if((i_61404 <= self__.level)){
var links_61405 = (update[i_61404]).forward;
if((x__$1 === (((i_61404 < links_61405.length))?(links_61405[i_61404]):null))){
(links_61405[i_61404] = (x__$1.forward[i_61404]));

var G__61406 = (i_61404 + (1));
i_61404 = G__61406;
continue;
} else {
var G__61407 = (i_61404 + (1));
i_61404 = G__61407;
continue;
}
} else {
...
var G__61409 = nx;
var G__61410 = (level__$1 - (1));
x = G__61409;
level__$1 = G__61410;
continue;
} else {
var G__61411 = x;
var G__61412 = (level__$1 - (1));
x = G__61411;
level__$1 = G__61412;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__61414 = nx;
var G__61415 = (level__$1 - (1));
x = G__61414;
level__$1 = G__61415;
continue;
} else {
var G__61416 = x;
var G__61417 = (level__$1 - (1));
x = G__61416;
level__$1 = G__61417;
continue;
}
