...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq68563){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq68563));
}));
...
var G__68620 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5802__auto__){
return (function (s,r){
return clojure.string.replace(s,cljs.core.re_pattern(r),((function (text,state,matches,temp__5802__auto__){
return (function (p1__68571_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__68571_SHARP_,p1__68571_SHARP_);
});})(text,state,matches,temp__5802__auto__))
);
});})(text,state,matches,temp__5802__auto__))
,text,matches);
var G__68621 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5802__auto__){
return (function (p1__68572_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__68572_SHARP_,matches);
});})(text,state,matches,temp__5802__auto__))
);
text = G__68620;
state = G__68621;
...
var G__68635 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__68636 = cljs.core.PersistentVector.EMPTY;
var G__68637 = cljs.core.rest(tokens);
var G__68638 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__68635;
buf = G__68636;
tokens = G__68637;
cur_state = G__68638;
...
var G__68639 = out;
var G__68640 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__68641 = cljs.core.rest(tokens);
var G__68642 = cur_state;
out = G__68639;
buf = G__68640;
tokens = G__68641;
cur_state = G__68642;
...
var G__68643 = out;
var G__68644 = buf;
var G__68645 = cljs.core.rest(tokens);
var G__68646 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__68643;
buf = G__68644;
tokens = G__68645;
cur_state = G__68646;
...
var G__68647 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__68648 = buf;
var G__68649 = cljs.core.rest(tokens);
var G__68650 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__68647;
buf = G__68648;
tokens = G__68649;
cur_state = G__68650;
