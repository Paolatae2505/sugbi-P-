...
var G__55790 = devtools.prefs.pref(v);
v = G__55790;
continue;
} else {
return v;
...
}catch (e55760){var _e__52814__auto__ = e55760;
return false;
}})();
...
}catch (e55764){var _e__52814__auto__ = e55764;
return false;
}})();
...
}catch (e55766){var _e__52814__auto__ = e55766;
return false;
}}
}
});
...
var vec__55779 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55779,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55779,(1),null);
...
return cljs.core.some((function (p1__55782_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__55782_SHARP_);
}),template);
});
