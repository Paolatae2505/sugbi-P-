...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_62830 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_62830(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_62831 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_62831(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62832 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62832(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62833 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62833(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62834 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62834(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62838 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62838(reader);
}
});
...
var G__62922 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__62923 = s.append(c);
c = G__62922;
s = G__62923;
continue;
}
