...
re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.input.input_node_set_value = (function re_frisk$inlined_deps$reagent$v1v0v0$reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__57953){
var map__57954 = p__57953;
var map__57954__$1 = cljs.core.__destructure_map(map__57954);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57954__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__57961_SHARP_){
return re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.input.input_handle_change(this$,on_change,p1__57961_SHARP_);
}));
