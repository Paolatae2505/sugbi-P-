...
return (function (p__64276,___$1){
var map__64277 = p__64276;
var map__64277__$1 = cljs.core.__destructure_map(map__64277);
var item = map__64277__$1;
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64277__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64277__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var app_db_diff = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64277__$1,new cljs.core.Keyword(null,"app-db-diff","app-db-diff",709588713));
var selected_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64277__$1,new cljs.core.Keyword(null,"selected?","selected?",-742502788));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64277__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var indx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64277__$1,new cljs.core.Keyword(null,"indx","indx",1571035590));
var search_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64277__$1,new cljs.core.Keyword(null,"search-filter","search-filter",274098807));
...
return (function (p__64282,___$1){
var map__64283 = p__64282;
var map__64283__$1 = cljs.core.__destructure_map(map__64283);
var item = map__64283__$1;
var trace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64283__$1,new cljs.core.Keyword(null,"trace?","trace?",1730690679));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64283__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.components.scroller,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-scroll","on-scroll",1590848677),(function (p1__64288_SHARP_){
var t = p1__64288_SHARP_.target;
...
})], null),(function (){var iter__5523__auto__ = (function re_frisk$ui$events$events_scroller_$_iter__64289(s__64290){
return (new cljs.core.LazySeq(null,(function (){
var s__64290__$1 = s__64290;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__64290__$1);
if(temp__5804__auto__){
var s__64290__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__64290__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__64290__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__64292 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__64291 = (0);
while(true){
if((i__64291 < size__5522__auto__)){
var item = cljs.core._nth(c__5521__auto__,i__64291);
cljs.core.chunk_append(b__64292,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.events.event_list_item,item,tool_state,checkbox_trace_val], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(item)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(checkbox_trace_val)].join('')], null)));

var G__64339 = (i__64291 + (1));
i__64291 = G__64339;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__64292),re_frisk$ui$events$events_scroller_$_iter__64289(cljs.core.chunk_rest(s__64290__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__64292),null);
}
} else {
var item = cljs.core.first(s__64290__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.events.event_list_item,item,tool_state,checkbox_trace_val], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(item)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(checkbox_trace_val)].join('')], null)),re_frisk$ui$events$events_scroller_$_iter__64289(cljs.core.rest(s__64290__$2)));
}
} else {
return null;
}
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__64302_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__64302_SHARP_,new cljs.core.Keyword(null,"selected?","selected?",-742502788),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(tool_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"selected-event","selected-event",898030638),new cljs.core.Keyword(null,"indx","indx",1571035590)], null)),new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(p1__64302_SHARP_)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"name","name",1843675177),(cljs.core.truth_(cljs.core.deref(truncate_checkbox_val))?new cljs.core.Keyword(null,"truncated-name","truncated-name",1771353320).cljs$core$IFn$_invoke$arity$1(p1__64302_SHARP_):cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword(null,"event","event",301435442).cljs$core$IFn$_invoke$arity$1(p1__64302_SHARP_)))),new cljs.core.Keyword(null,"search-filter","search-filter",274098807),new cljs.core.Keyword(null,"search-diff-path","search-diff-path",-507684436).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state)),new cljs.core.Keyword(null,"color","color",1011675173),cljs.core.get.cljs$core$IFn$_invoke$arity$2(clrs,cljs.core.first(new cljs.core.Keyword(null,"event","event",301435442).cljs$core$IFn$_invoke$arity$1(p1__64302_SHARP_)))], 0));
...
}),new cljs.core.Keyword(null,"active?","active?",459499776),false], null),"X"], null)], null)], null):null),(cljs.core.truth_(new cljs.core.Keyword(null,"events-opened?","events-opened?",-1069565502).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state)))?new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"gap","gap",80255254),"5px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.checkbox,new cljs.core.Keyword(null,"model","model",331153215),truncate_checkbox_val,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__64304_SHARP_){
return cljs.core.reset_BANG_(truncate_checkbox_val,p1__64304_SHARP_);
}),new cljs.core.Keyword(null,"label","label",1718410804),"truncate"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.checkbox,new cljs.core.Keyword(null,"model","model",331153215),checkbox_trace_val,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__64305_SHARP_){
return cljs.core.reset_BANG_(checkbox_trace_val,p1__64305_SHARP_);
}),new cljs.core.Keyword(null,"label","label",1718410804),"traces"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.gap,new cljs.core.Keyword(null,"size","size",1098693007),"100%"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"height","height",1025178622),"20px",new cljs.core.Keyword(null,"padding","padding",1660304693),"0",new cljs.core.Keyword(null,"width","width",-384071477),"30px"], null),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(max_text_val),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"max",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__64306_SHARP_){
return cljs.core.reset_BANG_(max_text_val,p1__64306_SHARP_.target.value);
...
var G__64315 = new cljs.core.Keyword(null,"events-colors","events-colors",-428819032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state));
var fexpr__64314 = cljs.core.deref(evnt_key);
return (fexpr__64314.cljs$core$IFn$_invoke$arity$1 ? fexpr__64314.cljs$core$IFn$_invoke$arity$1(G__64315) : fexpr__64314.call(null,G__64315));
} else {
return "";
}
}));
...
var map__64332 = new cljs.core.Keyword(null,"selected-event","selected-event",898030638).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state));
var map__64332__$1 = cljs.core.__destructure_map(map__64332);
var item = map__64332__$1;
var subs_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64332__$1,new cljs.core.Keyword(null,"subs?","subs?",-2085240020));
