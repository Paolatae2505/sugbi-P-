...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__68545){
var map__68546 = p__68545;
var map__68546__$1 = cljs.core.__destructure_map(map__68546);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68546__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__68548_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__5045__auto__ = p1__68548_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__68549){
var map__68550 = p__68549;
var map__68550__$1 = cljs.core.__destructure_map(map__68550);
var request = map__68550__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68550__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
