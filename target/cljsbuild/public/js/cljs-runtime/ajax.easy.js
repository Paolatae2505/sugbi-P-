...
var G__69062 = format;
var G__69062__$1 = (((G__69062 instanceof cljs.core.Keyword))?G__69062.fqn:null);
switch (G__69062__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__69063 = cljs.core.second(format);
var G__69064 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__69063,G__69064) : ajax.easy.keyword_response_format_element.call(null,G__69063,G__69064));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__69065 = format;
var G__69065__$1 = (((G__69065 instanceof cljs.core.Keyword))?G__69065.fqn:null);
switch (G__69065__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__69066_SHARP_){
return ajax.easy.keyword_response_format_element(p1__69066_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__69067){
var map__69068 = p__69067;
var map__69068__$1 = cljs.core.__destructure_map(map__69068);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69068__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69068__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69068__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__69069){
var vec__69070 = p__69069;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69070,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69070,(1),null);
var fexpr__69073_69090 = (cljs.core.truth_(ok)?h:e);
(fexpr__69073_69090.cljs$core$IFn$_invoke$arity$1 ? fexpr__69073_69090.cljs$core$IFn$_invoke$arity$1(result) : fexpr__69073_69090.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__69074){
var map__69075 = p__69074;
var map__69075__$1 = cljs.core.__destructure_map(map__69075);
var opts = map__69075__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69075__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69075__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69075__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69075__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69075__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
