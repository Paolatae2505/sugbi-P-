...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function markdown$lists$close_lists_$_iter__68849(s__68850){
return (new cljs.core.LazySeq(null,(function (){
var s__68850__$1 = s__68850;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__68850__$1);
if(temp__5804__auto__){
var s__68850__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68850__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__68850__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__68852 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__68851 = (0);
while(true){
if((i__68851 < size__5522__auto__)){
var vec__68856 = cljs.core._nth(c__5521__auto__,i__68851);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68856,(0),null);
cljs.core.chunk_append(b__68852,["</li></",cljs.core.name(list_type),">"].join(''));

var G__68900 = (i__68851 + (1));
i__68851 = G__68900;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68852),markdown$lists$close_lists_$_iter__68849(cljs.core.chunk_rest(s__68850__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68852),null);
}
} else {
var vec__68860 = cljs.core.first(s__68850__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68860,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__68849(cljs.core.rest(s__68850__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__68864_SHARP_){
return (cljs.core.second(p1__68864_SHARP_) > num_indents);
...
var vec__68869 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68869,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68869,(1),null);
...
var vec__68873 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68873,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68873,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__68880){
var map__68881 = p__68880;
var map__68881__$1 = cljs.core.__destructure_map(map__68881);
var state = map__68881__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68881__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68881__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68881__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68881__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
