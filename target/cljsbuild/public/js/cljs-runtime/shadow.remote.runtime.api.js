...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_65561 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_65561(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_65567 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_65567(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_65568 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_65568(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_65569 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_65569(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_65573 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_65573(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_65575 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_65575(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__65559,callback){
var map__65560 = p__65559;
var map__65560__$1 = cljs.core.__destructure_map(map__65560);
var input = map__65560__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65560__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65560__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
