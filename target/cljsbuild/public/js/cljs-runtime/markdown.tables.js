...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68914_SHARP_){
return cljs.core.identity(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),p1__68914_SHARP_], null));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.string.trim,(function (p1__68913_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__68913_SHARP_,/\|/);
})(clojure.string.trim((function (p1__68912_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__68912_SHARP_),"|")){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.rest(p1__68912_SHARP_));
} else {
return p1__68912_SHARP_;
}
})(text)))));
});
